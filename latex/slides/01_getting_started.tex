...
\begin{frame}{Editor/IDE}
	\begin{description}
		...
		\end{itemize}
		\lstinputlisting{resources/01_getting_started/Planet.py}
		IDLE?
	\end{description}
\end{frame}
...
\begin{frame}[fragile]{Erste Aufgabe}
	...
	\lstinputlisting{resources/01_getting_started/debug_question.py}
\end{frame}
\begin{frame}[fragile]{Debug-Funktion}
	...
	\begin{itemize}
		...
		\item<3-> Operatoren?
	\end{itemize}
	\lstinputlisting{resources/01_getting_started/debug_concat.py}
	\onslide<2->{\lstinputlisting{resources/01_getting_started/debug_main.py}}
\end{frame}
...
\begin{frame}[fragile]{besondere Operatoren}
	\begin{description}
		\onslide<1->{\item[\alert{\texttt{()}}] für Aufrufbares (Funktionen): \item \texttt{debug("{}A", 1, 7)}}
...
\begin{frame}[fragile]{Zusatz und Ausblick}
	Unschön:
	\lstinputlisting{resources/01_getting_started/debug_concat.py}
	\onslide<2->\lstinputlisting[lastline=10]{resources/01_getting_started/debug_format.py}
	\onslide<3->\lstinputlisting[lastline=10]{resources/01_getting_started/debug_loop_question.py}
\end{frame}

...
\begin{frame}{List Comprehension}
  ...
  \begin{description}
    ...
    \item[FILTER] Eine optionale boolean expression, womit Einträge gefiltert werden (falls \codeline{False}). N\"utzlich, wenn z.B. nur gerade Zahlen \"ubernommen werden sollen, usw...
  \end{description}
...
\section{Generators}
\begin{frame}{Generators}%TODO: Viel Spaß beim ueberarbeiten
	\begin{description}

...
\begin{frame}{Generators}
  Grundlegender Sytax ist gleich dem der list comprehention. Erzeugt ein iterable (generator). D.h. \codeline{list( EXPRESSION for VARIABLE in ITERABLE ) == [EXPRESSION for VARIABLE in ITERABLE]}
\end{frame}
